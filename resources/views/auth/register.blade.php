            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="documentType" class="col-md-4 col-form-label text-md-right">Tipo de documento</label>
                        ...
                        <div class="form-group row">
                            <label for="identification" class="col-md-4 col-form-label text-md-right">Numero de identificacion</label>
